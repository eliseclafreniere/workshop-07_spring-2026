...
# read xlsx reads in excel files 
...
**The missing value comes froma. pair of tanks in which the pH sensor malfunctioned, so there is no pH reading for those tanks.**  
